...
export default function ReservationCalendar() {
  ...
  const courts = ["Cancha de Fútbol 1", "Cancha de Tenis A", "Cancha de Baloncesto Central"]
  ...
  return (
    ...
    <Card className="w-[400px]">
      <CardHeader>
        ...
        <CardDescription>Seleccione una fecha para su reserva</CardDescription>
      </CardHeader>
      <CardContent>
        <Calendar
          mode="single"
          ...
          <DialogContent>
            ...
            <div className="grid gap-4 py-4">
              <div className="grid grid-cols-4 items-center gap-4">
                ...
                <Input id="date" value={date.toLocaleDateString()} className="col-span-3" readOnly />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
                <Label htmlFor="court" className="text-right">
                  Cancha
                </Label>
                <Input id="court" value={selectedCourt} className="col-span-3" readOnly />
              </div>
              <div className="grid grid-cols-4 items-center gap-4">
