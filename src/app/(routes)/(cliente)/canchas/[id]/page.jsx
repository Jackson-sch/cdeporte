...
const DetalleCanchita = () => {
  ...
  useEffect(() => {
    ...
    const canchitaEjemplo = {
      ...
      fotos: [
        'https://slm-assets.secondlife.com/assets/11053107/view_large/Cancha-de-futbol-con-balo%CC%81n_001.jpg?1423345518',
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRxA2fGt5NV_3ExDCbqtmKyPbVELdtOW-67Tg&s',
      ],
    };
